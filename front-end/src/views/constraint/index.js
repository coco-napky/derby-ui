...
class ConstraintView extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {constraint: {}, activeTab: '1',}
        this.loadData();
    ...
    loadData() {
        ...
        this.name = id;
        QueryService.queryTable('sys', 'SYSCONSTRAINTS', 'CONSTRAINTID', id)
         .then(response => {
            this.setState({...this.state, constraint: response.data.data.myArrayList[0].map})
        })
            ...
            <div className="w-100 d-flex justify-content-center vw-table">
                <Card className="main-card">
                    ...
                    <TabContent activeTab={this.state.activeTab} className="pt-2">
                        <TabPane tabId="1">
                            <ConstraintDetails data={this.state.constraint}/>
                        </TabPane>
                        <TabPane tabId="2">
                            <h2>Create</h2>
                        </TabPane>
